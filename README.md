...
### v3.5.3 (2026-03-08)
-  新增声纹识别与用户注册流程，支持多用户画像与角色绑定
-  引入动态角色语音切换，支持 Edge-TTS / GPT-SoVITS 等引擎
-  上线混合抗噪 VAD 与全链路延迟监控，提供抖动预警与报告
-  重制后端管理界面，现代化赛博风格与暗色适配
-  增加开发者工具链与文档：插件生成器、角色语音与延迟监控指南
-  完善项目结构与默认配置，补齐关键静态资源与示例数据
